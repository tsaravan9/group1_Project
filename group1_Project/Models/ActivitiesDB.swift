...
class ActivitiesDataSource {
    ...
    // private initializer
    private init() {
        activities.append(Activity("Bike Tour", 50, ActivityDetails("We are proud to be Amsterdam's smallest bike tour company! We work with a maximum of 12 participants (usually less!) per tour group to ensure you a personal and high quality tour. This three hour bike tour focuses on Amsterdam's undiscovered area's and the city's hidden gems. We will meet each other at our office in Amsterdam's city centre to pick up our first class bikes. You will discover secret courtyards, hidden churches and off-the-beaten path neighborhoods. While crossing canals and cruising through parks you will learn about Amsterdam fascinating history as well as the current city life of Amsterdammers. Hop on and we'll bike the extra mile!",3.5, "Bike Bulldozer", ["bike_tour_1", "bike_tour_2"], "1234567890")))
